            ...
            <div className="flex flex-col justify-center items-center w-full h-full px-10">
                ...
                <div className='max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-4'>
                    ...
                    <div className="font-medium">
                        <p>
                        Keen Coder with a hobby of playing games. Currently, I am pursuing BE in Information Technology from Vidyavardhini's College of Engineering and Technology, Vasai. I have made many websites using the skills mentioned below and lately I have started building RESPONSIVE websites. I have created many posters and designs using Photoshop and Adobe Illustrator. 
                        </p>
                    </div>
                </div>
            </div>
